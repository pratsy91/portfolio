    ...
    <div className="text-white font-mont fixed top-0 left-0 right-0 z-50">
      ...
      >
        <div className="flex justify-between items-center w-full">
          <Link to="/">
            <h1 className="text-4xl font-semibold hover:text-yellow-500 cursor-pointer flex gap-2">
              <BsCodeSlash /> P S C
            </h1>
          </Link>
        ...
        <div
          className={`mt-5 md:flex items-center justify-start w-full flex-col lg:hidden 2xl:hidden xl:hidden ${showMenu}`}
        >
          {menuItems.map((item) => {
            return (
              <li
